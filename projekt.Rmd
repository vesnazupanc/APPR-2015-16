...
Prva tabela prikazuje število umrlih glede na starost, spol ter leto.
  *Starost je od 0 let do 100+ let
  *Spol je ločen na moški in ženski
  *Leta so od 2010 pa do 2014 - številska spremenljivka
...
Moje spremenljivke so torej:
  *Spol (Moški, Ženski)
  *Regije (statistične regije) - imenska spremenljivka
  *Leto (2010-2014) - številska spremenljivka
  *Vzrok smrti (osnovni vzroki smrti) - imenska spremenljivka
  *MERITEV: število umrlih
...
Iz te tabele sem prav tako naredila dve manjši tabeli.

Prva prikazuje število smrti po vzrokih od leta 2010 pa do 2014:

```{r Bolezni, echo=FALSE}
kable(Bolezni)
```

Druga tabela pa prikazuje število smrti po regijah (skupaj v letih 2010-2014), ter koliko od teh je bilo umrlih Žensk ter koliko Moških:
